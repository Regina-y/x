...
namespace TelerikDemo
{
    public partial class RadForm1 : Telerik.WinControls.UI.RadForm
    {
        ...
        //        {
        //            return x is Telerik.WinControls.RichTextEditor.UI.HeaderFooterContainer;
        //        },
        ...
        private RadDocument LoadDocumentToInsert()
        {
            ...
            {
                string extension; extension = Path.GetExtension(ofd.SafeFileName).ToLower();
        ...
        private RadDocument LoadFile(string file)
        {
            ...
            RadDocument document = null;
            using (Stream stream = typeof(RadForm1).Assembly.GetManifestResourceStream("RichTextEditor.SampleDocuments." + file))
            {
                document = provider.Import(stream);
            }
            return document;
